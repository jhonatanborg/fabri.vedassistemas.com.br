...
when usuarios.nivel=2 then 'Solicitante'
when usuarios.nivel=3 then 'Autoridade'
when usuarios.nivel=4 then 'Empresa'
when usuarios.nivel=5 then 'Técnico'
when usuarios.nivel=6 then 'Inativo' end as nivel_descricao
FROM usuarios
JOIN
unidades ON usuarios.unidade = unidades.id ORDER BY usuarios.nome";
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $rows_users['unidade_nome']; ?>
